...
bool IsTheSame(const string& str1, const size_t pos1, const string& str2,
               const size_t pos2) {
  ...
  return 0 == str1.compare(pos1, str1.length() - pos1, str2, pos2,
                           str2.length() - pos2);
}
...
bool IsOneAway(const string& str1, const string& str2) {
  ...
  return IsTheSame(str1, i + 1, str2, i) || IsTheSame(str1, i, str2, i + 1) ||
