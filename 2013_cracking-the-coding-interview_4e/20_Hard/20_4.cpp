...
int main() {
  ...
  // the following equations should be right, they are mentioned in the official
  // solution count2s(513) = 5 * count2s(99) + count2s(13) + 100; count2s(279) =
