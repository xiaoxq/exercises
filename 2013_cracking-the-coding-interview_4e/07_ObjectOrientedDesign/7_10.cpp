...
class smart_ptr {
 public:
  smart_ptr(T* object) { smart_instance = new smart_ptr_impl<T>(object); }
  ...
  T* operator()() { return smart_instance->get_instance(); }
  int get_ref_count() { return smart_instance->get_ref_count(); }
...
///////////////// TEST /////////////////
struct test_struct {
  void who_am_i() { printf("I'm: %ul\n", this); }
  test_struct() { printf("Create struct: %ul\n", this); }
  ~test_struct() { printf("Destroy struct: %ul\n", this); }
};
