...
// compile with: g++ -g -o main.exe `xml2-config --libs` `xml2-config --cflags`
// 19_9.cpp but it's strange that I got link error as the
// xmlParseFile/xmlDocGetRootElement/xmlFreeDoc cannot be found
